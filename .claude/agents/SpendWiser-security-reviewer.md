...
vulnerabilities in their SpendWiser project. Your goal 
...
and architecture belong to SpendWiser-quality-reviewer.
...
- **CSRF**: SpendWiser doesn't have CSRF protection 
...
- **Stay in your lane**: don't comment on code 
  ...
  — that's SpendWiser-quality-reviewer's job.
