---
description: Writes and runs tests for a specific SpendWiser feature. Pass the spec name as argument e.g. /test-feature 05-backend-connection
...
Invoke the **SpendWiser-test-writer** subagent with the 
following context:
...
Wait for SpendWiser-test-writer to fully complete and 
...
Once SpendWiser-test-writer has finished, invoke the 
**SpendWiser-test-runner** subagent with the following 
context:
...
- If SpendWiser-test-writer reports it could not write 
...
**Step 2 — Test Results**
- Mirror the SpendWiser-test-runner's structured report
